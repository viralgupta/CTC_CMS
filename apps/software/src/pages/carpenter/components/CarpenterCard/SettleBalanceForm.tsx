...
const SettleBalanceForm = ({
  ...
  onSubmit: (values: Omit<z.infer<typeof settleBalanceType>, "carpenter_id" | "amount"> & { amount: string }) => void;
  ...
  const form = useForm<
    Omit<Omit<z.infer<typeof settleBalanceType>, "carpenter_id">, "amount"> & { amount: string }
  >({
    resolver: zodResolver(settleBalanceType.omit({ carpanter_id: true, amount: true }).extend({ amount: z.string() })),
