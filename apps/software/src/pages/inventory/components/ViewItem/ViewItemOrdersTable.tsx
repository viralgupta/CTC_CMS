        ...
        {item.order_items.map((oi) => {
          return (
            <TableRow>
              ...
              <TableCell className="text-center">{`₹${oi.total_value.toFixed(2)}`}</TableCell>
              <TableCell className="text-center">
                {oi.architect_commision
                  ? `₹${oi.architect_commision} ${oi.architect_commision_type == "percentage" ? "Percentage" : "Per Piece"}`
                  : "--"}
              </TableCell>
              <TableCell className="text-center">
                {oi.carpanter_commision
                  ? `₹${oi.carpanter_commision} ${oi.carpanter_commision_type == "percentage" ? "Percentage" : "Per Piece"}`
                  : "--"}
              </TableCell>
              <TableCell className="text-center">
                <Button
