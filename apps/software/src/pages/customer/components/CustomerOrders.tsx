...
const CustomerOrders = () => {
  ...
  return <div className="mt-2">
    ...
    <CustomerOrderTable type="active" orders={viewCustomer.orders.filter((order) => order.status === "Pending")} />
    <span className="font-sofiapro font-bold text-xl">Completed Orders</span>
    <CustomerOrderTable type="completed" orders={viewCustomer.orders.filter((order) => order.status === "Delivered")} />
  </div>;
};
...
export const CustomerOrderTable = ({
  ...
  return (
    <Table>
      <TableCaption>A list of customer's {type} orders.</TableCaption>
      <TableHeader>
        <TableRow>
