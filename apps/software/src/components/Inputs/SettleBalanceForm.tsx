...
const SettleBalanceForm = ({
  ...
  onSubmit: (values: Omit<z.infer<typeof settleBalanceType>, "architect_id" | "amount"> & { amount: string }) => void;
  ...
  const form = useForm<
    Omit<Omit<z.infer<typeof settleBalanceType>, "architect_id">, "amount"> & { amount: string }
  >({
    resolver: zodResolver(settleBalanceType.omit({ architect_id: true, amount: true }).extend({ amount: z.string() })),
