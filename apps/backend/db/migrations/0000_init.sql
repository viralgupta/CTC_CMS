...
CREATE TABLE IF NOT EXISTS "order" (
	...
	"o_carpenter_commision" numeric(10, 2),
...
CREATE TABLE IF NOT EXISTS "order_item" (
	...
	"oi_carpenter_commision" numeric(10, 2),
	"oi_carpenter_commision_type" varchar,
...
CREATE TABLE IF NOT EXISTS "order_movement" (
	...
	"om_delivered" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "tier_item" (
	"ti_id" serial PRIMARY KEY NOT NULL,
	"ti_tier_id" integer NOT NULL,
	"ti_item_id" integer NOT NULL,
	"t_carpenter_commision" numeric(10, 2) NOT NULL,
	"t_carpenter_commision_type" varchar NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "architect" ADD CONSTRAINT "architect_ar_tier_id_tier_t_id_fk" FOREIGN KEY ("ar_tier_id") REFERENCES "public"."tier"("t_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "carpenter" ADD CONSTRAINT "carpenter_ca_tier_id_tier_t_id_fk" FOREIGN KEY ("ca_tier_id") REFERENCES "public"."tier"("t_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "order" ADD CONSTRAINT "order_o_carpenter_id_carpenter_ca_id_fk" FOREIGN KEY ("o_carpenter_id") REFERENCES "public"."carpenter"("ca_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "phone_number" ADD CONSTRAINT "phone_number_pn_carpenter_id_carpenter_ca_id_fk" FOREIGN KEY ("pn_carpenter_id") REFERENCES "public"."carpenter"("ca_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tier_item" ADD CONSTRAINT "tier_item_ti_tier_id_tier_t_id_fk" FOREIGN KEY ("ti_tier_id") REFERENCES "public"."tier"("t_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tier_item" ADD CONSTRAINT "tier_item_ti_item_id_item_i_id_fk" FOREIGN KEY ("ti_item_id") REFERENCES "public"."item"("i_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
